...
export default function App(data) {
    ...
    const userForm = new UserForm({
        ...
        $targetUserForm: $targetUserForm,
        $targetInput: $targetInput,
        $targetPhone: $targetPhone,
        $targetEmail: $targetEmail,
        $targetIntroduce: $targetIntroduce,
        $targetAgreement: $targetAgreement,
        $targetCheckBox: $targetCheckBox,
        $targetCompleteButton1: $targetCompleteButton1,
    ...
    const familyForm = new FamilyForm({
        $targetTitle: $targetTitle,
        $targetAddFamilyFormData: $targetAddFamilyFormData,
